...
const Header = (prop) => {
    ...
    const bannerMessage = 'Entrega gratis';
    ...
    return ( <
        ...
        /button> <
        Link aria - label = "Favorites"
        href = "/account/favorites"
        className = { `${styles.iconContainer} ${styles.hideOnMobile}` } >
        <
        Icon symbol = { 'heart' } > < /Icon> <
        /Link> <
        Link aria - label = "Orders"
        ...
        <
        Drawer hideCross top = { '98px' }
        isReverse visible = { mobileMenu }
        close = {
            () => setMobileMenu(false) } >
        <
