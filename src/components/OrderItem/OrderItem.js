...
const OrderItem = (props) => {
    ...
    return ( <
        ...
        <
        div className = { `${headerStyling} ${styles.orderHeader}` }
        role = { 'presentation' }
        onClick = {
        ...
        span className = { styles.address } > { order.shippingAddress ? .name } <
        /span> <
        span className = { styles.address } > { order.shippingAddress ? .address } <
        /span> <
        span className = { styles.address } >
        { `${order.shippingAddress?.state} ${order.shippingAddress?.postal}` } < /span> <
        span className = { styles.address } > { order.shippingAddress ? .country } <
        /span> <
        /div> <
        div className = { styles.addressContainer } >
        <
        ...
        span className = { styles.address } > { order.billingAddress ? .address } <
        /span> <
        span className = { styles.address } >
        { `${order.billingAddress?.state} ${order.billingAddress?.postal}` } < /span> <
        span className = { styles.address } > { order.billingAddress ? .country } <
        /span> <
        /div> <
        /div>
