...
const OrderPage = (props) => {
    ...
    return ( <
        ...
        <
        span className = { styles.tableHeader } > Ordem# < /span> <
        span className = { styles.tableHeader } > Pedido feito < /span> <
        span className = { styles.tableHeader } > Última atualização < /span> <
        span className = { styles.tableHeader } > Status < /span> <
        /div>

        <
        OrderItem order = { sampleOrder1 }
        headerStyling = { styles.gridStyle }
        /> <
        OrderItem order = { sampleOrder2 }
        headerStyling = { styles.gridStyle }
        /> <
        /AccountLayout> <
        /Layout>
