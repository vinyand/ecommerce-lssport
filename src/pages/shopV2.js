...
const ShopV2Page = (props) => {
    ...
    return ( <
        ...
        <
        Breadcrumbs crumbs = {
            [{ link: '/', label: 'Home' }, { label: 'Woman' }] }
        /> <
        /Container> <
        Banner maxWidth = { '650px' }
        name = { `Woman` }
        subtitle = {
            'Olhe para os nossos suéteres femininos para looks modernos e prontos. De midis em estampas arrojadas a estilos dramáticos de varrer o chão e all-in-ones fáceis, nossa edição abrange todos os humores.'
        }
        /> <
        Container size = { 'large' }
        spacing = { 'min' } >
        ...
        /div> <
        ProductCardGrid height = { '440px' }
        data = { data } > < /ProductCardGrid> <
        /div> <
        /div> <
